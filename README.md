...
- [Docker Compose](https://docs.docker.com/get-started/get-docker/) to run the demo app
- (Optional) [k6 studio](https://grafana.com/docs/k6-studio/set-up/install/) installed